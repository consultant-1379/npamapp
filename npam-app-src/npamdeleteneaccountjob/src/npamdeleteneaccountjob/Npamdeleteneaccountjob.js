define([
    ...
    'i18n!npamdeleteneaccountjob/dictionary.json',
    'i18n!npamlibrary/dictionary.json',
    './NpamdeleteneaccountjobView',
    'npamlibrary/finish',
    ...
    return core.App.extend({
        ...
        appName: constants.DETACH_NE_ACCOUNTS_LINK.substring(1),
        ...
        initWizard: function () {
            ...
            this.finish = new finish(this.model, 'detachNeAccountsJob');
        ...
        getJSONData: function () {
            ...
            serverUtil.sendRestCall('POST', '/npamservice/v1/job/create', this.detachNeAccountsJobSuccess.bind(this),
                                    this.loadErrorMessage.bind(this), 'json', 'application/json',
                                    JSON.stringify(this.model.getAttribute('createJobJSON')));
            this.view.getLoadingAnimationHolder().removeModifier("hidden");
        },

        detachNeAccountsJobSuccess: function () {
            this.wizardReset = true;
            this.wizard.detach();
            this.layout.detach();
            //TODO Add Dialog or notification of success
