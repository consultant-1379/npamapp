define([
    ...
    'i18n!npamcheckneaccountconfigjob/dictionary.json',
    'i18n!npamlibrary/dictionary.json',
    './NpamcheckneaccountconfigjobView',
    'npamlibrary/finish',
    ...
    return core.App.extend({
        ...
        appName: constants.CHECK_NE_ACCOUNTS_CONFIG_LINK.substring(1),
        ...
        createFinisStep: function() {
            ...
            this.mainSchedule.execMode =  "IMMEDIATE";
            this.model.setAttribute('mainSchedule', this.mainSchedule);
            return new finish(this.model, constants.CHECKNEACCOUNTCONFIGJOB);
        },
...
//            }
        ...
        getJSONData: function () {
            ...
            serverUtil.sendRestCall('POST', '/npamservice/v1/job/create', this.checkneaccountconfigJobSuccess.bind(this),
                                    this.loadErrorMessage.bind(this), 'json', 'application/json',
                                    JSON.stringify(this.model.getAttribute('createJobJSON')));
            this.view.getLoadingAnimationHolder().removeModifier("hidden");
        },

        checkneaccountconfigJobSuccess: function () {
