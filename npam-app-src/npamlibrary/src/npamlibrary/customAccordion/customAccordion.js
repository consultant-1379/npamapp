define([
    ...
    return core.Widget.extend({
        ...
        init: function (options, content) {
            ...
            this.createAccordion(options.name);
            this.createAccTitle(content.getTableData().length, options.type);
// TORF-670644           this.attachDelBtn();
        },
        ...
        createAccTitle: function(length, type) {
            this.appendElement(this.createHTMLElement('span',' ('+length+') '));
        ...
        getTableData: function() {
            return this.content.getTableData();
        }
    });
