define([
    ...
    return core.View.extend({
        ...
        getTickIcon: function () {
            return this.getElement().find('.eaNpamlibrary-wResultCell-tick');
        },

        getErrorIcon: function () {
            return this.getElement().find('.eaNpamlibrary-wResultCell-error');
        },

        getWarningIcon: function () {
            return this.getElement().find('.eaNpamlibrary-wResultCell-warning');
        },

        showTickIcon: function (text) {
            this.getTickIcon().removeModifier('hidden');
            this.getElement().find(".eaNpamlibrary-wResultCell-tickTEXT").setText(text);
        },
        ...
        showErrorIcon: function (text) {
            ...
            this.getElement().find(".eaNpamlibrary-wResultCell-errorText").setText(text);
        },
        ...
        showWarningIcon: function (text) {
            ...
            this.getElement().find(".eaNpamlibrary-wResultCell-warningText").setText(text);
        },
        ...
        getResultText: function () {
            return this.getElement().find('.eaNpamlibrary-wResultCell-text');
        }
    });
